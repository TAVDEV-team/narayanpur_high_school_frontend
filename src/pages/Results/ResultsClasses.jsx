...
const classes = [
  { classId: 2, title: "Class 6", male: 19, female: 37, total: 56, icon: <BookOpen size={48} className="text-indigo-600" /> },
  { classId: 1, title: "Class 7", male: 28, female: 22, total: 50, icon: <NotebookText size={48} className="text-green-600" /> },
